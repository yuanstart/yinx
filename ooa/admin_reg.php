...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
  ...
  <tr class="tdbg">
    ...
    <td><?php echo $_SESSION['hyadmin'];?></td>
    <td style="display:none"><input name="username" type="username" value="<?php echo $_SESSION['hyadmin'];?>"  size="20" maxlength="12"></td>
  </tr>
  <tr class="tdbg">
  ...
  <tr class="tdbg">
    ...
    <td><input name="password1" type="password"  size="20" maxlength="12" style="width:100pt;"  > 
      4-20位字母、数字、特殊字符</td>
  </tr>
  <tr class="tdbg">
