...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border_tab">
  ...
  <tr class="tdbg">
    ...
    <td><INPUT name="title" type="text" id="title" size="25" maxlength="150"> <span class="red">*</span></td>
  </tr>
  <?php
  ...
  <tr class="tdbg">
    ...
    <td><INPUT name="ageno" type="text" id="ageno" size="25" maxlength="50"></td>
  </tr>
  <?php
  }
  ?>
  ...
  <tr class="tdbg">
    ...
    <td><INPUT name="area" type="text" id="area" size="57" maxlength="250"></td>
  </tr>
  <?php
  }
  ?>
  ...
  <tr class="tdbg">
    ...
    <td><INPUT name="idcard" type="text" id="idcard" size="25" maxlength="50"></td>
  </tr>
  <?php
  }
  ?>
  ...
  <tr class="tdbg">
    ...
    <td><INPUT name="wx" type="text" id="wx" size="25" maxlength="50"></td>
  </tr>
  <?php
  }
  ?>
  ...
  <tr class="tdbg">
    ...
    <td><INPUT name="qq" type="text" id="qq" size="25" maxlength="50"></td>
  </tr>
  <?php
  }
  ?>
  ...
  <tr class="tdbg">
    ...
    <td><INPUT name="phone" type="text" id="phone" size="25" maxlength="50"></td>
  </tr>
  <?php
  }
  ?>
  ...
  <tr class="tdbg">
    ...
    <td><input name="stime" type="text" id="stime" size="10" maxlength="50"  onclick="return Calendar('stime');"  /></td>
  </tr>
  <?php
  }
  ?>
  ...
  <tr class="tdbg">
    ...
    <td><input name="etime" type="text" id="etime" size="10" maxlength="50"  onclick="return Calendar('etime');" /></td>
  </tr>
  <?php
  }
  ?>
