...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border_tab">
  ...
  <tr class="tdbg">
    <td align="right">链接地址 多语言：</td>
    <td>
        <input name="link_url_lang" type="radio" class="radio" id="link_url_lang" value="true" <?php if ($conf['co']['link_url_lang']==true){echo' checked="checked"';}?> />
        公用
        <input name="link_url_lang" type="radio" class="radio" id="llink_url_lang2" value="false" <?php if ($conf['co']['link_url_lang']==false){echo' checked="checked"';}?>/>
        分开    </td>
  </tr>
  <tr class="tdbg">
  ...
  <tr class="tdbg">
    <td align="right">图片上传 多语言：</td>
    <td>
        <input name="img_sl_lang" type="radio" class="radio" id="img_sl_lang" value="true" <?php if ($conf['co']['img_sl_lang']==true){echo' checked="checked"';}?> />
        公用
        <input name="img_sl_lang" type="radio" class="radio" id="img_sl_lang2" value="false" <?php if ($conf['co']['img_sl_lang']==false){echo' checked="checked"';}?>/>
        分开    </td>
  </tr>
  <tr class="tdbg">
