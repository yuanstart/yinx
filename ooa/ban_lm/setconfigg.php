...
if (read_config('config')){
	//获取系统配置
	$sy_id=$conf['sy']['id']=(!empty($_POST['id']))?(int)html($_POST['id']):13;
	$conf['sy']['pre']=(!empty($_POST['pre']))?html($_POST['pre']):'ban';
	$conf['sy']['name']=(!empty($_POST['name']))?html($_POST['name']):'Banner';
	$conf['sy']['table_lm']=(!empty($_POST['table_lm']))?html($_POST['table_lm']):'ban_lm';
	$conf['sy']['table_co']=(!empty($_POST['table_co']))?html($_POST['table_co']):'ban_co';
