...
if (read_config('config')){
	...
	$sy_id=$conf['sy']['id']=(!empty($_POST['id']))?(int)html($_POST['id']):3;

	$conf['sy']['pre']=(!empty($_POST['pre']))?html($_POST['pre']):'cases';

	$conf['sy']['name']=(!empty($_POST['name']))?html($_POST['name']):'案例';

	$conf['sy']['table_lm']=(!empty($_POST['table_lm']))?html($_POST['table_lm']):'cases_lm';

	$conf['sy']['table_co']=(!empty($_POST['table_co']))?html($_POST['table_co']):'cases_co';
