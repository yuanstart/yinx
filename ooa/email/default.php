...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
  <tr class="tdbg3">
    <td width="70" align="right"><strong>邮件检索：</strong></td>
    <td>
...
<?php
$sql='select * from '.table('email_co').' where 1=1 '.$sq.' order by `id` desc';
...
?>
    <tr class="tdbg">
        ...
        <td align="center">
        <a href="send_email.php?id=<?php echo $row['id']?>">发送邮件</a> | 
