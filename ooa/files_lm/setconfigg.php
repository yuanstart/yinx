...
if (read_config('config')){
	//获取系统配置
	$sy_id=$conf['sy']['id']=(!empty($_POST['id']))?(int)html($_POST['id']):4;
	$conf['sy']['pre']=(!empty($_POST['pre']))?html($_POST['pre']):'down';
	$conf['sy']['name']=(!empty($_POST['name']))?html($_POST['name']):'下载';
	$conf['sy']['table_lm']=(!empty($_POST['table_lm']))?html($_POST['table_lm']):'down_lm';
	$conf['sy']['table_co']=(!empty($_POST['table_co']))?html($_POST['table_co']):'down_co';
