...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border_tab">
  ...
  <tr class="tdbg">
    ...
    <td><INPUT name="title<?php echo $v['lang']?>" type="text" id="title<?php echo $v['lang']?>" size="50" maxlength="150" value="<?php echo $row['title'.$v['lang']]?>">
    <?php 
	if ($v['must']==true){
  ...
  <tr class="tdbg" >          
    ...
    <td >
    <iframe name="frame1" id="frame1" src="up_image_tool/uploadd.php?frameid=frame1&kuang=img_sl2&img_sl=<?php echo $row['img_sl2']?>" style="margin-top:2px; width:auto; width:380px; height:22px; overflow:hidden;" frameborder="0"  scrolling="no"></iframe>           
    <input type="hidden" name="img_sl2" id="img_sl2" value="<?php echo $row['img_sl2']?>" >
  <?php
    if(!empty($conf['up']['text'])){
    ?>
        <br /><span class="red"><?php echo $conf['up']['text']?></span>
...
?>
  <tr class="tdbg">
    ...
    <td>
    <textarea name="ym_tit<?php echo $v['lang']?>" cols="75" rows="3"><?php echo rehtml($row['ym_tit'.$v['lang']])?></textarea><br />
...
?>
  <tr class="tdbg">
    ...
    <td >
    <textarea name="ym_key<?php echo $v['lang']?>" cols="75" rows="3"><?php echo rehtml($row['ym_key'.$v['lang']])?></textarea><br />
...
?>
  <tr class="tdbg">
    ...
    <td><textarea name="ym_des<?php echo $v['lang']?>" cols="75" rows="3"><?php echo rehtml($row['ym_des'.$v['lang']])?></textarea><br />
