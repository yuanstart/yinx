...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border_tab">
  ...
  ?>
  <tr class="tdbg" >          
    <td width="120" align="right">图片上传2：</td>          
    <td >
    <IFRAME name="frame1" id="frame1" src="up_image_tool/up.php?frameid=frame1&kuang=pic_sl_lm" style="margin-top:2px; width:auto; width:380px; height:22px; overflow:hidden;" frameborder="0"  scrolling="no"></iframe>            
    <input type="hidden" name="pic_sl_lm" id="pic_sl_lm">
    <?php
    if(!empty($conf_ul['up']['text'])){
  ?>
        <br /><span class="red"><?php echo $conf_ul['up']['text']?></span>
