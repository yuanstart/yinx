...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border_tab">
  ...
  <tr class="tdbg">
    <td align="right">分类是否使用 图片上传2：</td>
    <td>
        <input name="pic_sl_lm" type="radio" class="radio" id="pic_sl_lm" value="true" onclick="disdiv('ul2')" <?php if ($conf['lm']['pic_sl_lm']==true){echo' checked="checked"';}?> />
        使用
        <input name="pic_sl_lm" type="radio" class="radio" id="pic_sl_lm2" value="false" onclick="clodiv('ul2')" <?php if ($conf['lm']['pic_sl_lm']==false){echo' checked="checked"';}?>  />
        不使用
   </td>
  </tr>
...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border_tab">
  ...
  <tr class="tdbg">
    ...
    <td>
        ...
        ?>
        <table border="0" cellpadding="2" id="um">
          <tr class="tdbg2">
            <td align="right">上传目录：</td>
  ...
  <tr class="tdbg">
    <td align="right">图片2上传设置：</td>
    <td>
		<?php
        //加载信息图片2上传的配置文件
        if($conf_up=read_config('conf_up','../')){
        ?>
        <table border="0" cellpadding="2" id="up">
          <tr class="tdbg2">
            <td align="right">上传目录：</td>
  ...
  <tr class="tdbg">
    <td align="right">文件上传设置：</td>
    <td>
		<?php
        //加载文件上传的配置文件
        if($conf_uf=read_config('conf_uf','../')){
        ?>
        <table border="0" cellpadding="2" id="uf">
          <tr class="tdbg2">
            <td align="right">上传目录：</td>
  ...
  <tr class="tdbg">
    <td align="right">视频上传设置：</td>
    <td>
		<?php
        //加载文件上传的配置文件
        if($conf_uv=read_config('conf_uv','../')){
        ?>
        <table border="0" cellpadding="2" id="uv">
          <tr class="tdbg2">
            <td align="right">上传目录：</td>
  ...
  <tr class="tdbg">
    <td align="right">多图上传设置：</td>
    <td>
		<?php
        //加载多图上传的配置文件
        if($conf_pm=read_config('conf_pm','../')){
        ?>
        <table border="0" cellpadding="2" id="pm" >
          <tr class="tdbg2">
  ...
  <tr class="tdbg">
    <td align="right">相关信息设置：</td>
    <td>
		<?php
        //加载多图上传的配置文件
        if($conf_pi=read_config('conf_pi','../')){
        ?>
        <table border="0" cellpadding="2" id="pi" >
          <tr class="tdbg2">
            <td align="right">表名：</td>
  ...
  <tr class="tdbg">
    <td align="right">相关文件设置：</td>
    <td>
		<?php
        //加载多图上传的配置文件
        if($conf_pf=read_config('conf_pf','../')){
        ?>
        <table border="0" cellpadding="2" id="pf">
          <tr class="tdbg2">
            <td align="right">表名：</td>
  ...
  <tr class="tdbg">
    <td align="right">相关视频设置：</td>
    <td>
		<?php
        //加载多图上传的配置文件
        if($conf_pv=read_config('conf_pv','../')){
        ?>
        <table border="0" cellpadding="2" id="pv">
          <tr class="tdbg2">
            <td align="right">表名：</td>
  ...
  <tr class="tdbg">
    <td align="right">组图上传设置：</td>
    <td>
		<?php
        //加载多图上传的配置文件
        if($conf_pz=read_config('conf_pz','../')){
        ?>
        <table border="0" cellpadding="2" id="pz">
          <tr class="tdbg2">
            <td align="right">表名：</td>
