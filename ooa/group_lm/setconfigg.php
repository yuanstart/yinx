...
if (read_config('config')){
	//获取系统配置
	$sy_id=$conf['sy']['id']=(!empty($_POST['id']))?(int)html($_POST['id']):6;
	$conf['sy']['pre']=(!empty($_POST['pre']))?html($_POST['pre']):'info';
	$conf['sy']['name']=(!empty($_POST['name']))?html($_POST['name']):'信息';
	$conf['sy']['table_lm']=(!empty($_POST['table_lm']))?html($_POST['table_lm']):'info_lm';
	$conf['sy']['table_co']=(!empty($_POST['table_co']))?html($_POST['table_co']):'info_co';
	...
	$conf['lm']['pic_sl_lm']=(!empty($_POST['pic_sl_lm']))?changety(html($_POST['pic_sl_lm'])):false;
...
if (read_config('conf_pi','../')){
	...
	$conf['pl']['img_sl2']=(!empty($_POST['pi_img_sl2']))?changety(html($_POST['pi_img_sl2'])):true;
