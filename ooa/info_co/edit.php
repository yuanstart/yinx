...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border_tab">
  ...
  <tr class="tdbg dis_info_from" style="display:none;">           
    ...
    <td ><input name="info_from<?php echo $v['lang']?>" type="text" id="info_from<?php echo $v['lang']?>"  value="<?php echo $row['info_from'.$v['lang']]?>" size="24"   maxlength="50">
          &nbsp; <?php echo $v['name']?>信息作者：<input name="info_author<?php echo $v['lang']?>" type="text" id="info_author<?php echo $v['lang']?>"  value="<?php echo $row['info_author'.$v['lang']]?>" size="23"   maxlength="50"/>
    </td >
  </tr>
  <?php
		if ($conf['co']['mlang']!=true){
  ...
  <tr class="tdbg dis_img_sl" style="display:none;">          
    ...
    <td >
    <iframe name="frame1" id="frame1" src="up_image_tool/uploadd.php?frameid=frame1&kuang=img_sl&img_sl=<?php echo $row['img_sl']?>&id=<?php echo $row['lm']?>" style="margin-top:2px; width:auto; width:380px; height:22px; overflow:hidden;" frameborder="0"  scrolling="no"></iframe>  			    
  ...
  <tr class="tdbg dis_pic_sl" style="display:none;">          
    ...
    <td >
    <iframe name="frame4" id="frame4" src="up_pic_tool/uploadd.php?frameid=frame4&kuang=pic_sl&img_sl=<?php echo $row['pic_sl']?>&id=<?php echo $row['lm']?>" style="margin-top:2px; width:auto; width:380px; height:22px; overflow:hidden;" frameborder="0"  scrolling="no"></iframe>  			    
