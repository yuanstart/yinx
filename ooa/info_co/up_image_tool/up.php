...
gt('formn').action="upload.php?frameid=<?php echo $frameid?>&kuang=<?php echo $kuang?>&id=<?php echo $id?>"
gt('formn').submit();
} 
// 是否有效的扩展名
...
<input type="hidden" name="MAX_FILE_SIZE" value="<?php echo $conf['up']['maxsize']?>" />  
