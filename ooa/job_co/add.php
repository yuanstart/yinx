...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border_tab">
  ...
  <tr class="tdbg">
    ...
    <td><INPUT name="link_url" type="text" id="link_url" size="50" maxlength="250"></td>
  </tr>
  <?php
  }
  ?>
  ...
  <tr class="tdbg">
    ...
    <td><INPUT name="num" type="text" id="num" size="25"  maxlength="50"></td>
  </tr>
  <?php
  }
  ?>
  ...
  <tr class="tdbg">
    ...
    <td><INPUT name="address<?php echo $v['lang']?>" type="text" id="address<?php echo $v['lang']?>" size="25" maxlength="50"></td>
  </tr>
  <?php
		if ($conf['co']['mlang']!=true){
			break;
  ...
  ?>
    <tr class="tdbg">
      <td width="120" align="right">开始日期：</td>
        <td ><input name="stime" type="text" id="stime" size="25" value="<?php echo date('Y-m-d')?>" maxlength="50"  onclick="return Calendar('stime');"></td>          
    </tr>
  <?php
  }
  ?>
  ...
  ?>
    <tr class="tdbg">
      <td width="120" align="right">结束日期：</td>
        <td ><input name="etime" type="text" id="etime" size="25" value="<?php echo date('Y-m-d',(time()+30*24*60*60))?>" maxlength="50"  onclick="return Calendar('etime');" /></td>          
    </tr>
  <?php
  }
  ?>
  ...
  <tr class="tdbg">
    ...
    <td ><textarea name="f_body<?php echo $v['lang']?>" rows="4" id="f_body<?php echo $v['lang']?>"  style="width:670px;height:200px;display:none;"></textarea></td>
  </tr>
  <?php
		if ($conf['co']['mlang']!=true){
			break;
  ...
  <tr class="tdbg">
    ...
    <td><textarea id="z_body<?php echo $v['lang']?>" name="z_body<?php echo $v['lang']?>" style="width:670px;height:200px;display:none;"></textarea></td>
  </tr>
  <?php
		if ($conf['co']['mlang']!=true){
			break;
