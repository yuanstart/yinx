...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
  ...
  ?>
  <tr class="tdbg">
    <td width="120" align="right"><?php if ($v['name']!=''){echo $v['name'].'昵称';}else{echo '昵　　称';}?>：</td>
    <td><INPUT name="rename<?php echo $v['lang']?>" type="text" id="rename<?php echo $v['lang']?>" value="<?php echo $row['rename'.$v['lang']]?>" size="30" maxlength="50"></td>
  </tr>
  <?php
