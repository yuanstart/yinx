...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border_tab">
  ...
  <tr class="tdbg">
    ...
    <td><INPUT name="link_url<?php echo $v['lang']?>" type="text" id="link_url<?php echo $v['lang']?>" size="57" maxlength="250"></td>
  </tr>
  <?php
  ...
  <tr class="tdbg" >          
    ...
    <td >
    <iframe name="frame1<?php echo $v['lang']?>" id="frame1<?php echo $v['lang']?>" src="up_image_tool/up.php?frameid=frame1<?php echo $v['lang']?>&kuang=img_sl<?php echo $v['lang']?>" style="margin-top:2px; width:auto; width:380px; height:22px; overflow:hidden;" frameborder="0"  scrolling="no"></iframe>  			    
    <input type="hidden" name="img_sl<?php echo $v['lang']?>" id="img_sl<?php echo $v['lang']?>">
    <?php
