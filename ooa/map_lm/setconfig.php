...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border_tab">
  ...
  <tr class="tdbg">
    ...
    <td>
        <input name="zuobiao" type="radio" class="radio" id="zuobiao" value="true" <?php if ($conf['co']['zuobiao']==true){echo' checked="checked"';}?> />
        使用
        <input name="zuobiao" type="radio" class="radio" id="zuobiao2" value="false" <?php if ($conf['co']['zuobiao']==false){echo' checked="checked"';}?>/>
        不使用    </td>
  </tr>
  <tr class="tdbg">
