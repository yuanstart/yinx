...
if (read_config('config')){
	//获取系统配置
	$sy_id=$conf['sy']['id']=(!empty($_POST['id']))?(int)html($_POST['id']):12;
	$conf['sy']['pre']=(!empty($_POST['pre']))?html($_POST['pre']):'orders';
	$conf['sy']['name']=(!empty($_POST['name']))?html($_POST['name']):'订单';
	$conf['sy']['table_co']=(!empty($_POST['table_co']))?html($_POST['table_co']):'orders';
