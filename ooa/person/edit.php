...
checkaction($conf['sy']['pre'].'_view');//检查权限
...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" id="d_1">
 ...
 <tr>
  ...
  <tr>
    ...
    <td class="tdbg">
    <input  name="password" type="password"  style="WIDTH: 150px" size="25" maxlength="20" canEmpty="Y" checkType="password,4,20" checkStr="密码"  /> 
    4-20字母+数字+特殊字符 ，不能使用汉字，<span class="red">为空表示不修改</span></td>
  </tr>
<?php
...
?>
  <tr>
        ...
        <td class="tdbg">
        <input type="text" name="rename"  style="WIDTH: 150px" size="25" maxlength="100" id="rename" value="<?php echo $row['rename']?>"/>    </td>
  </tr>
<?php
}
?>
...
?>
    <tr>
        ...
        <td class="tdbg">
        <input type="text" name="phone" style="WIDTH: 150px" size="25" maxlength="50" value="<?php echo $row['phone']?>"/></td>
    </tr>
<?php
}
?>
...
?>
    <tr>
        ...
        <td class="tdbg">
         <input type="text" name="fax" style="WIDTH: 150px" size="25" maxlength="50" id="mobile"  value="<?php echo $row['fax']?>"/>   </td>
    </tr>
<?php
}
?>
...
?>
    ...
    邮箱：</td>
    <td class="tdbg">
    <input type="text" name="email" style="WIDTH: 150px" size="25" maxlength="50" canEmpty="Y" checkType="email,," checkStr="邮箱" id="email"  value="<?php echo $row['email']?>"/></td>   
  </tr>
<?php
}
?>
...
?>
    <tr>
        ...
        <td class="tdbg">
          <input type="text" name="qq" id="qq" style="WIDTH: 150px" value="<?php echo $row['qq']?>" size=25 maxlength="50" /></td>
    </tr>
<?php
}
?>
...
?>
    <tr>
        ...
        <td class="tdbg">
          <input type="text" name="wx" id="wx" style="WIDTH: 150px" value="<?php echo $row['wx']?>" size=25 maxlength="50" /></td>
    </tr>
<?php
}
?>
...
?> 
    <tr>
        ...
        <td class="tdbg">
        <input type="text" name="compname" style="WIDTH: 250px" size=25 maxlength="100" id="compname" value="<?php echo $row['compname']?>">    </td>
  </tr>
<?php
}
?>
...
?>
  <tr>
        ...
        <td class="tdbg">
          <input type="text" name="address" style="WIDTH: 250px" size=25 maxlength="50" value="<?php echo $row['address']?>" /></td>
  </tr>
<?php
}
?>
...
?>
    <tr>
        ...
        <td class="tdbg">
          <input type="text" name="post" id="post" style="WIDTH: 150px" value="<?php echo $row['post']?>" size=25 maxlength="50" /></td>
    </tr>
<?php
}
?>
...
?>
    <tr>
        ...
        <td class="tdbg">
          <textarea name="z_body" cols="25" rows="5"  style="WIDTH: 350px;"><?php echo rehtml($row['z_body'])?></textarea></td>
    </tr>
<?php
}
?>
