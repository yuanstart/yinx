...
.filelist li{ width:80px;float:left; margin:3px 8px 0 2px; padding:0px; list-style:none; position:relative;}
...
.inputclass { width:50px; height:15px; margin-top:1px; padding:1px;}
</style>
</head>
      ...
      <option value="0" selected="selected">请选择分类</option>
        ...
        <tr class="tdbg">
            ...
            <td>
                ...
                <!--浏览按钮-->
                <div id="container"><input id="pickfiles" type="button" name="Submit1" value="选 择 图 片" class="btn" style="_padding:0px;"> <input id="clearfiles" type="button" name="Submit2" value="删 除 选 择" class="btn" style="_padding:0px;"> <span class="red"><?php echo $conf['up']['text'];?></span></div>
                <!--总的进度条-->
	...
	init: {
		...
		FilesAdded: function(up, files) {
			...
			<?php
			  ...
			  ?>
				inhtml+='<div>排序<input name="px[]" id="px_'+files[i].id+'" type="text" class="inputclass" value="100"><input name="img_sl[]" type="text" class="inputclass" style="display:none;" id="img_sl_'+files[i].id +'"></div>';
				inhtml+='</li>';
