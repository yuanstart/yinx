...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border_tab">
  ...
  <tr class="tdbg">
    ...
    <td><INPUT name="pro_can1<?php echo $v['lang']?>" type="text" id="pro_can1<?php echo $v['lang']?>" size="30"  maxlength="50"></td>
  </tr>
  <?php
		if ($conf['co']['mlang']!=true){
			break;
  ...
  <tr class="tdbg">
    ...
    <td><INPUT name="pro_can2<?php echo $v['lang']?>" type="text" id="pro_can2<?php echo $v['lang']?>" size="30"  maxlength="50"></td>
  </tr>
  <?php
		if ($conf['co']['mlang']!=true){
			break;
  ...
  <tr class="tdbg">
    ...
    <td><INPUT name="pro_can3<?php echo $v['lang']?>" type="text" id="pro_can3<?php echo $v['lang']?>" size="30"  maxlength="50"></td>
  </tr>
  <?php
		if ($conf['co']['mlang']!=true){
			break;
  ...
  <tr class="tdbg">
    ...
    <td><INPUT name="pro_can4<?php echo $v['lang']?>" type="text" id="pro_can4<?php echo $v['lang']?>" size="30"  maxlength="50"></td>
  </tr>
  <?php
		if ($conf['co']['mlang']!=true){
			break;
  ...
  <tr class="tdbg">
    ...
    <td><textarea id="t_body<?php echo $v['lang']?>" name="t_body<?php echo $v['lang']?>" style="width:670px;height:300px;display:none;"></textarea></td>
  </tr>
  <?php
		if ($conf['co']['mlang']!=true){
			break;
  ...
  <tr class="tdbg">
    ...
    <td><textarea id="g_body<?php echo $v['lang']?>" name="g_body<?php echo $v['lang']?>" style="width:670px;height:300px;display:none;"></textarea></td>
  </tr>
  <?php
		if ($conf['co']['mlang']!=true){
			break;
