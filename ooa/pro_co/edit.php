...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border_tab">
  ...
  ?>
  <tr class="tdbg">
    <td width="120" align="right"><?php echo $v['name']?>产地：</td>
    <td><INPUT name="pro_can1<?php echo $v['lang']?>" type="text" id="pro_can1<?php echo $v['lang']?>" size="50" maxlength="50" value="<?php echo $row['pro_can1'.$v['lang']]?>"></td>
  </tr>
  <?php
		if ($conf['co']['mlang']!=true){
			break;
  ...
  ?>
  <tr class="tdbg">
    <td width="120" align="right"><?php echo $v['name']?>规格：</td>
    <td><INPUT name="pro_can2<?php echo $v['lang']?>" type="text" id="pro_can2<?php echo $v['lang']?>" size="50" maxlength="50" value="<?php echo $row['pro_can2'.$v['lang']]?>"></td>
  </tr>
  <?php
		if ($conf['co']['mlang']!=true){
			break;
  ...
  ?>
  <tr class="tdbg">
    <td width="120" align="right"><?php echo $v['name']?>颜色：</td>
    <td><INPUT name="pro_can3<?php echo $v['lang']?>" type="text" id="pro_can3<?php echo $v['lang']?>" size="50" maxlength="50" value="<?php echo $row['pro_can3'.$v['lang']]?>"></td>
  </tr>
  <?php
		if ($conf['co']['mlang']!=true){
			break;
  ...
  ?>
  <tr class="tdbg">
    <td width="120" align="right"><?php echo $v['name']?>售价：</td>
    <td><INPUT name="pro_can4<?php echo $v['lang']?>" type="text" id="pro_can4<?php echo $v['lang']?>" size="50" maxlength="50" value="<?php echo $row['pro_can4'.$v['lang']]?>"></td>
  </tr>
  <?php
		if ($conf['co']['mlang']!=true){
			break;
  ...
  ?>
  <tr class="tdbg">
    <td width="120" align="right"><?php echo $v['name']?>产品特性：</td>
    <td><textarea id="t_body<?php echo $v['lang']?>" name="t_body<?php echo $v['lang']?>" style="width:670px;height:300px;display:none;"><?php echo $row['t_body'.$v['lang']]?></textarea></td>
  </tr>
  <?php
		if ($conf['co']['mlang']!=true){
			break;
  ...
  ?>
  <tr class="tdbg">
    <td width="120" align="right"><?php echo $v['name']?>产品规格：</td>
    <td><textarea id="g_body<?php echo $v['lang']?>" name="g_body<?php echo $v['lang']?>" style="width:670px;height:300px;display:none;"><?php echo $row['g_body'.$v['lang']]?></textarea></td>
  </tr>
  <?php
		if ($conf['co']['mlang']!=true){
			break;
  ...
  <script>
        ...
        KindEditor.ready(function(K) {
		  ...
		  if ($conf['co']['t_body']==true){
		  	foreach ($cong['mlang'] as $k=>$v){
		  ?>
				K.create('textarea[name="t_body<?php echo $v['lang']?>"]',options);
		  <?php
				if ($conf['co']['mlang']!=true){
					break;
				}
		  ...
		  if ($conf['co']['g_body']==true){
		  	foreach ($cong['mlang'] as $k=>$v){
		  ?>
				K.create('textarea[name="g_body<?php echo $v['lang']?>"]',options);
		  <?php
				if ($conf['co']['mlang']!=true){
					break;
				}
