...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border_tab">
  ...
  <tr class="tdbg">
    <td align="right">是否使用 产地：</td>
    <td>
        <input name="pro_can1" type="radio" class="radio" id="pro_can1" value="true" <?php if ($conf['co']['pro_can1']==true){echo' checked="checked"';}?> />
        使用
        <input name="pro_can1" type="radio" class="radio" id="pro_can12" value="false" <?php if ($conf['co']['pro_can1']==false){echo' checked="checked"';}?>/>
        不使用    </td>
  </tr>
  <tr class="tdbg">
    <td align="right">是否使用 规格：</td>
    <td>
        <input name="pro_can2" type="radio" class="radio" id="pro_can2" value="true" <?php if ($conf['co']['pro_can2']==true){echo' checked="checked"';}?> />
        使用
        <input name="pro_can2" type="radio" class="radio" id="pro_can22" value="false" <?php if ($conf['co']['pro_can2']==false){echo' checked="checked"';}?>/>
        不使用    </td>
  </tr>
  <tr class="tdbg">
    <td align="right">是否使用 颜色：</td>
    <td>
        <input name="pro_can3" type="radio" class="radio" id="pro_can3" value="true" <?php if ($conf['co']['pro_can3']==true){echo' checked="checked"';}?> />
        使用
        <input name="pro_can3" type="radio" class="radio" id="pro_can32" value="false" <?php if ($conf['co']['pro_can3']==false){echo' checked="checked"';}?>/>
        不使用    </td>
  </tr>
  <tr class="tdbg">
    <td align="right">是否使用 售价：</td>
    <td>
        <input name="pro_can4" type="radio" class="radio" id="pro_can4" value="true" <?php if ($conf['co']['pro_can4']==true){echo' checked="checked"';}?> />
        使用
        <input name="pro_can4" type="radio" class="radio" id="pro_can42" value="false" <?php if ($conf['co']['pro_can4']==false){echo' checked="checked"';}?>/>
        不使用    </td>
  </tr>
  <tr class="tdbg">
  ...
  <tr class="tdbg">
    <td align="right">是否使用 产品特性：</td>
    <td>
        <input name="t_body" type="radio" class="radio" id="t_body" value="true" <?php if ($conf['co']['t_body']==true){echo' checked="checked"';}?> />
        使用
        <input name="t_body" type="radio" class="radio" id="t_body2" value="false" <?php if ($conf['co']['t_body']==false){echo' checked="checked"';}?>/>
        不使用    </td>
  </tr>
  <tr class="tdbg">
    <td align="right">是否使用 产品规格：</td>
    <td>
        <input name="g_body" type="radio" class="radio" id="g_body" value="true" <?php if ($conf['co']['g_body']==true){echo' checked="checked"';}?> />
        使用
        <input name="g_body" type="radio" class="radio" id="g_body2" value="false" <?php if ($conf['co']['g_body']==false){echo' checked="checked"';}?>/>
        不使用    </td>
  </tr>
  <tr class="tdbg">
  ...
  <tr class="tdbg">
    <td align="right">是否使用 文件上传：</td>
    <td>
        <input name="fil_sl" type="radio" class="radio" id="fil_sl" value="true" onclick="disdiv('uf')" <?php if ($conf['co']['fil_sl']==true){echo' checked="checked"';}?>/>
        使用
        <input name="fil_sl" type="radio" class="radio" id="fil_sl2" value="false" onclick="clodiv('uf')" <?php if ($conf['co']['fil_sl']==false){echo' checked="checked"';}?>/>
        不使用
		<?php
        //加载文件上传的配置文件
        if($conf_uf=read_config('conf_uf','../')){
        ?>
        <table border="0" cellpadding="2" id="uf" <?php if ($conf['co']['fil_sl']!=true){echo' style="display:none;"';}?>>
          <tr class="tdbg2">
            <td align="right">上传目录：</td>
            <td><input name="uf_path" type="text" size="20" maxlength="50" value="<?php echo $conf_uf['up']['path']?>"> 放在网站目录下的文件夹</td>
          </tr>
          <tr class="tdbg2">
            <td align="right" >上传大小：</td>
            <td ><input name="uf_maxsize" type="text"  size="20" maxlength="50" value="<?php echo $conf_uf['up']['maxsize']?>">
            B</td>
          </tr>
          <tr class="tdbg2">
            <td align="right">上传提醒：</td>
            <td><input name="uf_text" type="text"  size="40" maxlength="50" value="<?php echo $conf_uf['up']['text']?>"></td>
          </tr>
          <tr class="tdbg2">
            <td align="right">保留原名：</td>
            <td>
            <input name="uf_kname" type="radio" class="radio" value="true"  <?php if ($conf_uf['up']['kname']==true){echo' checked="checked"';}?> />
            保留
            <input name="uf_kname" type="radio" class="radio" value="false" <?php if ($conf_uf['up']['kname']==false){echo' checked="checked"';}?>/>
            不保留
            </td>
          </tr>
        </table>
  ...
  <tr class="tdbg">
    <td align="right">是否使用 视频上传：</td>
    <td>
        <input name="vid_sl" type="radio" class="radio" id="vid_sl" value="true" onclick="disdiv('uv')" <?php if ($conf['co']['vid_sl']==true){echo' checked="checked"';}?> />
        使用
        <input name="vid_sl" type="radio" class="radio" id="vid_sl2" value="false" onclick="clodiv('uv')" <?php if ($conf['co']['vid_sl']==false){echo' checked="checked"';}?>/>
        不使用
		<?php
        //加载文件上传的配置文件
        if($conf_uv=read_config('conf_uv','../')){
        ?>
        <table border="0" cellpadding="2" id="uv" <?php if ($conf['co']['vid_sl']!=true){echo' style="display:none;"';}?>>
          <tr class="tdbg2">
            <td align="right">上传目录：</td>
            <td><input name="uv_path" type="text" size="20" maxlength="50" value="<?php echo $conf_uv['up']['path']?>"> 放在网站目录下的文件夹</td>
          </tr>
          <tr class="tdbg2">
            <td align="right" >上传大小：</td>
            <td ><input name="uv_maxsize" type="text"  size="20" maxlength="50" value="<?php echo $conf_uv['up']['maxsize']?>">
            B</td>
          </tr>
          <tr class="tdbg2">
            <td align="right">上传提醒：</td>
            <td><input name="uv_text" type="text"  size="40" maxlength="50" value="<?php echo $conf_uv['up']['text']?>"></td>
          </tr>
        </table>
        <?php
        }
