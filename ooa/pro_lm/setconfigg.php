...
if (read_config('config')){
	//获取系统配置
	$sy_id=$conf['sy']['id']=(!empty($_POST['id']))?(int)html($_POST['id']):7;
	$conf['sy']['pre']=(!empty($_POST['pre']))?html($_POST['pre']):'pro';
	$conf['sy']['name']=(!empty($_POST['name']))?html($_POST['name']):'产品';
	$conf['sy']['table_lm']=(!empty($_POST['table_lm']))?html($_POST['table_lm']):'pro_lm';
	$conf['sy']['table_co']=(!empty($_POST['table_co']))?html($_POST['table_co']):'pro_co';
	...
	$conf['co']['pro_can1']=(!empty($_POST['pro_can1']))?changety(html($_POST['pro_can1'])):false;
	$conf['co']['pro_can2']=(!empty($_POST['pro_can2']))?changety(html($_POST['pro_can2'])):false;
	$conf['co']['pro_can3']=(!empty($_POST['pro_can3']))?changety(html($_POST['pro_can3'])):false;
	$conf['co']['pro_can4']=(!empty($_POST['pro_can4']))?changety(html($_POST['pro_can4'])):false;
	...
	$conf['co']['t_body']=(!empty($_POST['t_body']))?changety(html($_POST['t_body'])):false;
	$conf['co']['g_body']=(!empty($_POST['g_body']))?changety(html($_POST['g_body'])):false;
