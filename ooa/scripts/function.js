...
function popImage(obj,img){ 
	...
	if ((ext=="gif")||(ext=="jpg")||(ext=="bmp")||(ext=="png")){
		var content ="<br><IMG id='img_m' src='"+img+"' id='img_m' onload='DrawImage(this,220,220);' border='0'   style='FILTER: alpha(opacity=10);' >"; 
	}else{
		var content ="<br><br><br><IMG id='img_m' src='../images/img/"+ext+".gif' id='img_m' onload='DrawImage(this,220,220);' border='0'   style='FILTER: alpha(opacity=10);' >"; 
	}
