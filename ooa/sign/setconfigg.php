...
if (read_config('config')){
	//获取系统配置
	$sy_id=$conf['sy']['id']=(!empty($_POST['id']))?(int)html($_POST['id']):11;
	$conf['sy']['pre']=(!empty($_POST['pre']))?html($_POST['pre']):'sign';
	$conf['sy']['name']=(!empty($_POST['name']))?html($_POST['name']):'报名';
	$conf['sy']['table_co']=(!empty($_POST['table_co']))?html($_POST['table_co']):'sign';
