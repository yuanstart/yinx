...
$sql='update '.table($conf['pl']['table']).' set `link_url`="'.$link_url.'"'.$title_val.''.$z_body_val.',`img_sl`="'.$img_sl.'",`fil_sl`="'.$fil_sl.'"'.$ym_tit_val.''.$ym_key_val.''.$ym_des_val.',`px`='.$px.' where id='.$id.'';
$db->execute($sql);
